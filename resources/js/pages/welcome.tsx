...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="flex min-h-screen flex-col items-center bg-gradient-to-r from-white via-red-50 to-red-100 p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-gradient-to-r dark:from-red-950 dark:via-red-900 dark:to-red-950">
                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium">
                                Let's get startedsdsdsdxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
                            </h1>
